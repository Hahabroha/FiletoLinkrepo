...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        l = msg_text ="""<i><u>𝗬𝗼𝘂𝗿 𝗟𝗶𝗻𝗸 𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 !</u></i>\n\n<b>📂 Fɪʟᴇ ɴᴀᴍᴇ :</b> <i>{}</i>\n\n<b>📦 Fɪʟᴇ ꜱɪᴢᴇ :</b> <i>{}</i>\n\n<b>📥 Dᴏᴡɴʟᴏᴀᴅ :</b> <i>{}</i>\n\n<b> 🖥WATCH  :</b> <i>{}</i>\n\n<b>🚸 Nᴏᴛᴇ : LINK WON'T EXPIRE TILL I DELETE ᴛʜɪꜱ ɢᴇɴᴇʀᴀᴛᴇᴅ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ ɪɴ 2 ᴍɪɴꜱ 😊 ꜰᴀʀᴡᴀʀᴅ ᴜᴛ ᴛᴏ ꜱᴏᴍᴇᴡʜᴇʀᴇ ɪꜰ ᴜ ᴡᴀɴᴛ ᴛᴏ ꜱᴀᴠᴇ ɪᴛ</b>"""
