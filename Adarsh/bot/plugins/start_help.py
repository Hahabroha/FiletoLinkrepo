...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        await m.reply_photo(
            photo="https://graph.org/file/7ab16216c835da32bd18f.jpg",
            caption="**ʜᴇʟʟᴏ...⚡\n\nɪᴀᴍ ᴀ sɪᴍᴘʟᴇ ᴛᴇʟᴇɢʀᴀᴍ ғɪʟᴇ/ᴠɪᴅᴇᴏ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʟɪɴᴋ ᴀɴᴅ sᴛʀᴇᴀᴍ ʟɪɴᴋ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ.**\n\n**ᴜsᴇ /help ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛsɪʟs\n\nsᴇɴᴅ ᴍᴇ ᴀɴʏ ᴠɪᴅᴇᴏ / ғɪʟᴇ ᴛᴏ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀᴢ...😉**",
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/khandudon302"), InlineKeyboardButton("ᴍʏ ʙᴇꜱᴛ ꜰʀɪᴇɴᴅ", url="https://t.me/settings")],
                ]
            ),
...
async def help_handler(bot, message):
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/khandudon302"), InlineKeyboardButton(" ᴍʏ ꜰᴀᴠᴏʀɪᴛᴇ ᴘᴇʀꜱᴏɴ", url="https://t.me/settings")],
                ]
            ),
...
<b>╭━━━━━━━〔ɴᴇᴠᴇʀ ꜰᴏʟᴅ〕</b>
┃
┣⪼<b>ʙᴏᴛ ɴᴀᴍᴇ : ꜱᴛʀᴇᴀᴍ ʙᴏᴛ
┣⪼<b>sᴇʀᴠᴇʀ : ʜᴇʀᴜᴋᴏ</b>
┣⪼<b>ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ</b>
┣⪼<b>ʟᴀɴɢᴜᴀɢᴇ: ᴘʏᴛʜᴏɴ 3</b>
┣⪼<b>ɴᴏᴛᴇ: ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ꜰʀᴇᴇ ꜰʀᴏᴍ ᴜɴɴᴇᴄᴇꜱꜱᴀʀʏ ʙʀᴏᴀᴅᴄᴀꜱᴛꜱ ꜰʀᴏᴍ ᴏᴡɴᴇʀꜱ. ᴀɴʏᴏɴᴇ ᴄᴀɴ ᴜꜱᴇ.
┣⪼<b>ᴡᴇ ᴅᴏɴᴛ ᴄᴀʀᴇ ᴀɴʏᴛʜɪɴɢ ʏᴏᴜ ꜱᴇɴᴅ ᴛᴏ ᴛʜɪꜱ ʙᴏᴛ. ᴛʜᴇ ʙᴀᴅ ᴛʜᴇ ɢᴏᴏᴅ ᴛʜᴇ ᴜɢʟʏ. 😊
┃
<b>╰━━━━━━━〔ɴᴇᴠᴇʀ ʙᴀᴄᴋ ᴅᴏᴡɴ〕</b>""",
