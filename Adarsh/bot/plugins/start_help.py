...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        await m.reply_photo(
            photo="https://graph.org/file/b86a08fa455966558a035.jpg",
            caption="**ʜᴇʟʟᴏ...⚡\n\nɪᴀᴍ ᴀ sɪᴍᴘʟᴇ ᴛᴇʟᴇɢʀᴀᴍ ғɪʟᴇ/ᴠɪᴅᴇᴏ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʟɪɴᴋ ᴀɴᴅ sᴛʀᴇᴀᴍ ʟɪɴᴋ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ.**\n\n**ᴜsᴇ /help ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛsɪʟs\n\nsᴇɴᴅ ᴍᴇ ᴀɴʏ ᴠɪᴅᴇᴏ / ғɪʟᴇ ᴛᴏ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀᴢ...😉**",
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/khandudon302"), InlineKeyboardButton("ᴍʏ ʙᴇꜱᴛ ꜰʀɪᴇɴᴅ", url="tg://settings")],
                ]
            ),
...
async def help_handler(bot, message):
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/khandudon302"), InlineKeyboardButton(" ᴍʏ ꜰᴀᴠᴏʀɪᴛᴇ ᴘᴇʀꜱᴏɴ", url="tg://settings")],
                ]
            ),
...
┣⪼<b>ɴᴏᴛᴇ: ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ꜰʀᴇᴇ ꜰʀᴏᴍ ᴜɴɴᴇᴄᴇꜱꜱᴀʀʏ ʙʀᴏᴀᴅᴄᴀꜱᴛꜱ 
┃<b> ꜰʀᴏᴍ ᴏᴡɴᴇʀꜱ. ᴀɴʏᴏɴᴇ ᴄᴀɴ ᴜꜱᴇ.
┣<b>ᴡᴇ ᴅᴏɴᴛ ᴄᴀʀᴇ ᴀɴʏᴛʜɪɴɢ ʏᴏᴜ ꜱᴇɴᴅ ᴛᴏ ᴛʜɪꜱ ʙᴏᴛ.
┃<b> ᴛʜᴇ ʙᴀᴅ ᴛʜᴇ ɢᴏᴏᴅ ᴛʜᴇ ᴜɢʟʏ. 😊
┃
<b>╰━━━━━━━〔ɴᴇᴠᴇʀ ʙᴀᴄᴋ ᴅᴏᴡɴ〕</b>""",
